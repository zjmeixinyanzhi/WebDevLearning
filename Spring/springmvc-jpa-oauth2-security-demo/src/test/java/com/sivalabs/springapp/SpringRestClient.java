...
import com.sivalabs.springapp.entities.AuthTokenInfo;
import com.sivalabs.springapp.entities.User;

 
public class SpringRestClient {
 
    public static final String REST_SERVICE_URI = "http://localhost:8080/springmvc-datajpa-security-demo";
    
    public static final String AUTH_SERVER_URI = "http://localhost:8080/springmvc-datajpa-security-demo/oauth/token";
    ...
    private static void listAllUsers(AuthTokenInfo tokenInfo){
        ...
        ResponseEntity<List> response = restTemplate.exchange(REST_SERVICE_URI+"/rest/users/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
    ...
    private static void getUser(AuthTokenInfo tokenInfo){
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        ResponseEntity<User> response = restTemplate.exchange(REST_SERVICE_URI+"/rest/users/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
    ...
    private static void createUser(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        User user = new User(1,"Tomy","zhangjie@qq.com","123456", null);
        HttpEntity<Object> request = new HttpEntity<Object>(user, getHeaders());
        URI uri = restTemplate.postForLocation(REST_SERVICE_URI+"/rest/users/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
        		request, User.class);
    ...
    private static void deleteUser(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        restTemplate.exchange(REST_SERVICE_URI+"/rest/users/1"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
    ...
    private static void deleteAllUsers(AuthTokenInfo tokenInfo) {
        ...
        RestTemplate restTemplate = new RestTemplate();
        HttpEntity<String> request = new HttpEntity<String>(getHeaders());
        restTemplate.exchange(REST_SERVICE_URI+"/rest/users/"+QPM_ACCESS_TOKEN+tokenInfo.getAccess_token(),
        		HttpMethod.DELETE, request, User.class);
    }
